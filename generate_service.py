...
def paschalion(month:int, day:int, year:int):
    """
...
def generate_day(month:int=None, day:int=None, year:int=None, calendar:int=1):
    """
    ...
    date_oc = today - timedelta(days=13)
